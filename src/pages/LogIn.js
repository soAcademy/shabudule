  ...
  return (
    <>
      <div className="bg-neutral-300 h-screen flex justify-center">
        <div className="bg-neutral-50 m-auto md:w-1/2 w-full mx-2  border-4 border-red-700 rounded-lg mt-[70px]">
          ...
          <form onClick={logInPage} id="logIn-form">
            <div className="text-center">
              <button
                className=" bg-red-700 mb-2 text-neutral-50 font-bold md:w-1/3 w-3/4 p-2 mt-4 rounded-lg mx-auto  md:text-base text-sm"
                type="submit"
                variant="contained"
              >
                Log In
